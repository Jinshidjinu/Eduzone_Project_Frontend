...
import login from '../../assets/Images/LoginImg/SingleImg.svg'
            ...
            <div className="bg-white flex flex-col md:flex-row items-center rounded-2xl shadow-lg max-w-3/4 p-5 md:p-10  mt-12">
                ...
                <div className='md:w-1/2 p-2'>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center mt-3">
                        <p className="text-xs md:text-sm mb-2 md:mb-0">Don't have an account? <Link to='/signup' className="text-blue-600">Register here!</Link></p>
